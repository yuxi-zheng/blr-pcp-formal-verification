...
\end{remark}
\begin{proposition}[Group characters]\label{prop:group_characaters}\uses{lem:group}\lean{BlrPcp.gChar, BlrPcp.gChar_mul, BlrPcp.card_gChar_index, BlrPcp.gChar_injective}\leanok
...
\begin{lemma}[Lift operation from BLR condition]\label{lem:rep-iff-blr}\uses{lem:group, def:finite-field-blr-test, def:Flift, approx-representation}\lean{BlrPcp.liftFin_isApproxRepresentation}\leanok
