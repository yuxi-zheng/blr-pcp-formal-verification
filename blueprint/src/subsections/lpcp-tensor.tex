...
\begin{definition}\label{tensor-language}\lean{TENSORQ}\leanok
...
\begin{theorem}\label{tensor-lpcp}\uses{tensor-product, tensor-language}\lean{TENSORQ_LPCP}\leanok
...
\begin{corollary}\label{tensor-lpcp-binary}\uses{tensor-product, tensor-language}\lean{TENSORQ_LPCP_Zmod2}\leanok
\[
