...
\begin{theorem}\label{tensor-lpcp}\uses{tensor-product, tensor-language}\lean{TENSORQ_LPCP}
...
\begin{corollary}\label{tensor-lpcp-binary}\uses{tensor-product, tensor-language}\lean{TENSORQ_LPCP_Zmod2}
\[
