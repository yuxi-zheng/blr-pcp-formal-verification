...
Hence
\[
  \Pr_{s,t}\!\left[\text{verifier rejects}\right]
  \geq \left(1 - \tfrac{1}{|\F|}\right)^{\!2},
\]
and therefore
\[
  \Pr_{s,t}\!\left[\text{verifier accepts}\right]
...
\begin{theorem}\label{TENSORQ_LPCP}\uses{tensor-product, TENSORQ}\lean{TENSORQ_LPCP}\leanok
...
\begin{corollary}\label{TENSORQ_LPCP_Zmod2}\uses{TENSORQ}\leanok
\[
