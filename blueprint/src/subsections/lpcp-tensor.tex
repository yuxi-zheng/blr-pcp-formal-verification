...
\begin{definition}\label{TENSORQ.selfVerifier}\lean{TENSORQ.selfVerifier}\uses{tensor-product}\leanok
...
\begin{lemma}\label{TENSORQ.selfVerifier_soundness_after_sampling}\lean{TENSORQ.selfVerifier_soundness_after_sampling}\uses{TENSORQ.selfVerifier,TENSORQ.verifier_soundness_after_sampling}\leanok
