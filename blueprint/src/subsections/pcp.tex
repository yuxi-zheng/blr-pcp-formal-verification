...
The remaining sections construct the exponential-length PCP for
\(\QESAT(\F_2,n)\) by first giving an LPCP and then converting that LPCP proof
oracle into an ordinary PCP proof oracle.
