...
\begin{lemma}[Gowers-Hatami-Correlation]\label{gowers-hatami-correlation}\lean{gh2_average_correlation}\uses{UnitarySigmaError, approx-representation, sigma_proximity_iff}
