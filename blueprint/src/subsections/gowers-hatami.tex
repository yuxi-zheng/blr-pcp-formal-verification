...
\begin{definition}[Unitary Representation]\label{UnitaryRep}
...
\begin{definition}[Regular representation]\label{RegularRep}\uses{UnitaryRep}
...
\begin{theorem}[Gowers-Hatami-2]\label{gowers-hatami-2}\lean{gowers_hatami_GH2_product}\leanok
  \uses{sigmaNormSqSub, approx-representation, gowers-hatami-correlation}
