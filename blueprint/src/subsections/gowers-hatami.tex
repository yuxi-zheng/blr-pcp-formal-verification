...
\begin{lemma}[Gowers-Hatami-Correlation]\label{gowers-hatami-correlation}\lean{gh2_average_correlation}\uses{approx-representation}
...
\begin{theorem}[Gowers-Hatami-2]\label{gowers-hatami-2}\lean{gowers_hatami}
  \uses{UnitarySigmaError, approx-representation, gowers-hatami-correlation}
